...
def test_get_time_offset(request_mock) -> None:
    ...
    NTPTime("pool.ntp.org").get_time_offset()
...
@patch("ntplib.NTPClient.request")
def test_get_time_offset_return_value(request_mock) -> None:
